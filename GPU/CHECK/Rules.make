#
# Makefile for PM/Tree code namu.exe - April 1, 2010 - JKIM
#
...
#########################################################
AR = ar rcv
FC = mpif90 -Msecond_underscore
CC = mpicc
F90C = pgf90 -Msecond_underscore
NVCC = nvcc
FFTWDIR = /home/kjhan/fftw/
#OPT = -DPGCC -pc 80 -mcmodel=medium -Mlarge_arrays -tp k8-64 -O3 -Mnontemporal # -mp
OPT = -DPGCC -mcmodel=medium -O3 #-mp
# CUDA OPTIMIZATION
CUOPT = -O3 
# CUDA DIRECTORY
CUDA = /usr/local/cuda/
# CUDA SDK DIRECTORY
CUDA_SDK = /home/kjhan/CUDA_SDK/NVIDIA_CUDA_SDK
...
CDFLAGS = -DWGROUPSIZE=100 -DNMEG=1700L -DINCLUDE_TREE_FORCE \
...
LIBS = -L$(FFTWDIR)/lib/ -lsrfftw_mpi -lsfftw_mpi -lsrfftw -lsfftw   $(CAMBLIBS)  -L$(CUDA)/lib64 -lcudart
