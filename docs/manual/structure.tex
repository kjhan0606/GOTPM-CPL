%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PSC3 (GOTPM) Technical Reference Manual
% Style definition
% Based on cuRAMSES-kjhan manual format
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\lstdefinestyle{ccode}{
    language=C,
    morekeywords={float,double,long,int,void,char,size_t,
    pmparticletype,treeparticletype,SimParameters,INT8,
    memorystruct,indextype}
}

\lstdefinestyle{fortran}{
    language=[95]Fortran,
    morekeywords={integer,real,logical,character,common,
    external,function,subroutine,end,call,if,then,else,endif,
    do,enddo,return}
}

\lstdefinestyle{bash}{
    language=bash,
    morekeywords={make,mpirun,srun,sbatch,cd,cp,export}
}

\lstdefinestyle{paramstyle}{
    basicstyle=\ttfamily\small,
    backgroundcolor=\color{codebg},
    frame=single,
    rulecolor=\color{codeframe},
...
% Theorem / Algorithm
\newtcolorbox[auto counter,number within=chapter]{algorithm}[1][]{%
    enhanced,breakable,
    colback=darkblue!5,
    colframe=darkblue!80,
    coltitle=white,
    fonttitle=\bfseries\sffamily,
    title=Algorithm~\thetcbcounter\ifstrempty{#1}{}{~(#1)},
    attach boxed title to top left={yshift=-2mm,xshift=5mm},
