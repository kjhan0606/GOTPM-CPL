...
#define GenerateParallelComp(TYPE,subtype,mem)  \
	...
	int Psort_##TYPE##_##subtype##_##mem##_R(const void *a, const void *lb, const void *lc){\
		if(((TYPE*)a)->mem >= LONG_MAX) return 0;\
		else if(((TYPE*)lb)->mem == ((TYPE*)lc)->mem) return 1;\
		else if(Psort_##TYPE##_##subtype##_##mem(a,lc) >=0 || Psort_##TYPE##_##subtype##_##mem(a,lb) ==-1) return 1;\
		else return 0;\
	} 
...
void *pqsort(void *, size_t *, size_t, int (*)(const void *, const void *, const void *), 
...
#define MyPqsort(base,nmem,n_size,TYPE,subtype,mem,Comm) do{\
	...
	int Psort_##TYPE##_##subtype##_##mem##_R(const void *, const void *, const void *);\
	int id,mid;\
