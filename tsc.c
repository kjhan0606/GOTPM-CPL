...
static int nid,myid;
static int NZWIDTH=4;


void tsc(float *den, int local_nz, int nstart_z, pmparticletype *pmp, int np, float pmas){
	float  start_z;
	float pmas0,p05;
...
#else
	for(i=slicesize*(local_nz+2)-1;i>=0;i--){
